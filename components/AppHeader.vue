...
<style scoped>
    ...
    .main-nav-mobile-con{position: absolute;background-color: black;top: 0;right: 0;width: 219px;height: 100%;box-shadow: 0 0 18px -4px #e4b53679;}
    .main-nav-mobile-con ul li {margin-bottom: 5px;}
    .nav-mobile-main-logo {float: left;width: 37%;padding: 10px 0 0 15px;}
