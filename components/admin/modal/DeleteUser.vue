<template>
    <div class="delete-modal">
        ...
        <div class="delete-modal-con">
                ...
                <button @click="delete_modal_is_active = false">Cancel</button>
...
<style scoped>
    .delete-modal { position: absolute; right: 0; top: 100%; z-index: 500; } 
  .delete-modal-con { background: #fff; padding: 20px; border-radius: 5px;position: relative; cursor: default;} 
